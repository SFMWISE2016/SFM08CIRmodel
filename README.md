...
Output: 'MLE estimates of the parameters of the CIR model using 1-year yield to maturity of China's treasure bond; the simulated short rate series (figure1); the term structure given different short rates (figure2, figure3 and figure4).'

```
![Picture1](figure1.png)
![Picture1](figure2.png)
![Picture1](figure3.png)
![Picture1](figure4.png)
